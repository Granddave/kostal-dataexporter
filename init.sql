...
(
    ...
    pv_generator_dc_input_2_voltage numeric NOT NULL,
    pv_generator_dc_input_2_current numeric NOT NULL,
    pv_generator_dc_input_2_power numeric NOT NULL,
    pv_generator_dc_input_3_voltage numeric NOT NULL,
    pv_generator_dc_input_3_current numeric NOT NULL,
    pv_generator_dc_input_3_power numeric NOT NULL,
    house_home_consumption_covered_by_solar_generator numeric NOT NULL,
    house_home_consumption_covered_by_battery numeric NOT NULL,
    ...
    grid_grid_parameters_limitation_on numeric NOT NULL,
